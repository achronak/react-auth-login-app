...
export const unitActionConstants = {
    ...
    UNITS_BOOK_REQUEST: 'UNITS_BOOK_REQUEST',
    UNITS_BOOK_SUCCESS: 'UNITS_BOOK_SUCCESS',
    UNITS_BOOK_FAILURE: 'UNITS_BOOK_FAILURE',

    UNITS_SEARCH_REQUEST: 'UNITS_SEARCH_REQUEST',
    UNITS_SEARCH_SUCCESS: 'UNITS_SEARCH_SUCCESS',
    UNITS_SEARCH_FAILURE: 'UNITS_SEARCH_FAILURE',
};
